---
permalink: /1.13/cilium/v2/ciliumClusterwideNetworkPolicy/
---
...
## obj spec.ingress.auth

"Auth is the required authentication type for the allowed traffic, if any."

### fn spec.ingress.auth.withType
...
## obj specs.egress.auth

"Auth is the required authentication type for the allowed traffic, if any."

### fn specs.egress.auth.withType
...
## obj specs.ingress.auth

"Auth is the required authentication type for the allowed traffic, if any."

### fn specs.ingress.auth.withType
