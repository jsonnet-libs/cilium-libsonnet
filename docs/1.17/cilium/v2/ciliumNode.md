---
permalink: /1.17/cilium/v2/ciliumNode/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.ipam`](#obj-specipam)
    ...
    * [`fn withStatic-Ip-Tags(static_ip_tags)`](#fn-specipamwithstatic-ip-tags)
    * [`fn withStatic-Ip-TagsMixin(static_ip_tags)`](#fn-specipamwithstatic-ip-tagsmixin)
...
### fn spec.ipam.withStatic-Ip-Tags

```ts
withStatic-Ip-Tags(static_ip_tags)
```
...
### fn spec.ipam.withStatic-Ip-TagsMixin

```ts
withStatic-Ip-TagsMixin(static_ip_tags)
```
