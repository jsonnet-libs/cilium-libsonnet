---
permalink: /1.18/cilium/v2/ciliumEgressGatewayPolicy/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withEgressGateways(egressGateways)`](#fn-specwithegressgateways)
  * [`fn withEgressGatewaysMixin(egressGateways)`](#fn-specwithegressgatewaysmixin)
  ...
  * [`obj spec.egressGateways`](#obj-specegressgateways)
    * [`fn withEgressIP(egressIP)`](#fn-specegressgatewayswithegressip)
    * [`fn withInterface(interface)`](#fn-specegressgatewayswithinterface)
    * [`obj spec.egressGateways.nodeSelector`](#obj-specegressgatewaysnodeselector)
      * [`fn withMatchExpressions(matchExpressions)`](#fn-specegressgatewaysnodeselectorwithmatchexpressions)
      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specegressgatewaysnodeselectorwithmatchexpressionsmixin)
      * [`fn withMatchLabels(matchLabels)`](#fn-specegressgatewaysnodeselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specegressgatewaysnodeselectorwithmatchlabelsmixin)
      * [`obj spec.egressGateways.nodeSelector.matchExpressions`](#obj-specegressgatewaysnodeselectormatchexpressions)
        * [`fn withKey(key)`](#fn-specegressgatewaysnodeselectormatchexpressionswithkey)
        * [`fn withOperator(operator)`](#fn-specegressgatewaysnodeselectormatchexpressionswithoperator)
        * [`fn withValues(values)`](#fn-specegressgatewaysnodeselectormatchexpressionswithvalues)
        * [`fn withValuesMixin(values)`](#fn-specegressgatewaysnodeselectormatchexpressionswithvaluesmixin)
  * [`obj spec.selectors`](#obj-specselectors)
    ...
    * [`obj spec.selectors.nodeSelector`](#obj-specselectorsnodeselector)
      * [`fn withMatchExpressions(matchExpressions)`](#fn-specselectorsnodeselectorwithmatchexpressions)
      * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specselectorsnodeselectorwithmatchexpressionsmixin)
      * [`fn withMatchLabels(matchLabels)`](#fn-specselectorsnodeselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specselectorsnodeselectorwithmatchlabelsmixin)
      * [`obj spec.selectors.nodeSelector.matchExpressions`](#obj-specselectorsnodeselectormatchexpressions)
        * [`fn withKey(key)`](#fn-specselectorsnodeselectormatchexpressionswithkey)
        * [`fn withOperator(operator)`](#fn-specselectorsnodeselectormatchexpressionswithoperator)
        * [`fn withValues(values)`](#fn-specselectorsnodeselectormatchexpressionswithvalues)
        * [`fn withValuesMixin(values)`](#fn-specselectorsnodeselectormatchexpressionswithvaluesmixin)
...
### fn spec.withEgressGateways

```ts
withEgressGateways(egressGateways)
```
...
### fn spec.withEgressGatewaysMixin

```ts
withEgressGatewaysMixin(egressGateways)
```
...
## obj spec.egressGateways

"Optional list of gateway nodes responsible for SNATing traffic.\nIf this field has any entries the contents of the egressGateway field will be ignored.\nIn case multiple nodes are a match for the given set of labels in each entry,\nthe first node in lexical ordering based on their name will be selected for each entry."

### fn spec.egressGateways.withEgressIP
...
### fn spec.egressGateways.withInterface
...
## obj spec.egressGateways.nodeSelector

"This is a label selector which selects the node that should act as\negress gateway for the given policy.\nIn case multiple nodes are selected, only the first one in the\nlexical ordering over the node names will be used.\nThis field follows standard label selector semantics."

### fn spec.egressGateways.nodeSelector.withMatchExpressions
...
### fn spec.egressGateways.nodeSelector.withMatchExpressionsMixin
...
### fn spec.egressGateways.nodeSelector.withMatchLabels
...
### fn spec.egressGateways.nodeSelector.withMatchLabelsMixin
...
## obj spec.egressGateways.nodeSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.egressGateways.nodeSelector.matchExpressions.withKey
...
### fn spec.egressGateways.nodeSelector.matchExpressions.withOperator
...
### fn spec.egressGateways.nodeSelector.matchExpressions.withValues
...
### fn spec.egressGateways.nodeSelector.matchExpressions.withValuesMixin
...
## obj spec.selectors.nodeSelector
...
### fn spec.selectors.nodeSelector.withMatchExpressions
...
### fn spec.selectors.nodeSelector.withMatchExpressionsMixin
...
### fn spec.selectors.nodeSelector.withMatchLabels
...
### fn spec.selectors.nodeSelector.withMatchLabelsMixin
...
## obj spec.selectors.nodeSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.selectors.nodeSelector.matchExpressions.withKey
...
### fn spec.selectors.nodeSelector.matchExpressions.withOperator
...
### fn spec.selectors.nodeSelector.matchExpressions.withValues
...
### fn spec.selectors.nodeSelector.matchExpressions.withValuesMixin
