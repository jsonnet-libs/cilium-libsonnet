{
  ...
  spec: {
    ...
    eni: {
      ...
      '#withNode-Subnet-Id':: d.fn(help='"NodeSubnetID is the subnet of the primary ENI the instance was brought up with. It is used as a sensible default subnet to create ENIs in."', args=[d.arg(name='node_subnet_id', type=d.T.string)]),
    ...
    ipam: {
      ...
      pools: {
        '#allocated':: d.obj(help='"Allocated contains the list of pooled CIDR assigned to this node. The operator will add new pod CIDRs to this field, whereas the agent will remove CIDRs it has released."'),
        allocated: {
        ...
        '#requested':: d.obj(help='"Requested contains a list of IPAM pool requests, i.e. indicates how many addresses this node requests out of each pool listed here. This field is owned and written to by cilium-agent and read by the operator."'),
        requested: {
          '#needed':: d.obj(help='"Needed indicates how many IPs out of the above Pool this node requests from the operator. The operator runs a reconciliation loop to ensure each node always has enough PodCIDRs allocated in each pool to fulfill the requested number of IPs here."'),
          needed: {
            '#withIpv4-Addrs':: d.fn(help='"IPv4Addrs contains the number of requested IPv4 addresses out of a given pool"', args=[d.arg(name='ipv4_addrs', type=d.T.integer)]),
            'withIpv4-Addrs'(ipv4_addrs): { needed+: { 'ipv4-addrs': ipv4_addrs } },
            '#withIpv6-Addrs':: d.fn(help='"IPv6Addrs contains the number of requested IPv6 addresses out of a given pool"', args=[d.arg(name='ipv6_addrs', type=d.T.integer)]),
        ...
        '#withAllocated':: d.fn(help='"Allocated contains the list of pooled CIDR assigned to this node. The operator will add new pod CIDRs to this field, whereas the agent will remove CIDRs it has released."', args=[d.arg(name='allocated', type=d.T.array)]),
        withAllocated(allocated): { spec+: { ipam+: { pools+: { allocated: if std.isArray(v=allocated) then allocated else [allocated] } } } },
        '#withAllocatedMixin':: d.fn(help='"Allocated contains the list of pooled CIDR assigned to this node. The operator will add new pod CIDRs to this field, whereas the agent will remove CIDRs it has released."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allocated', type=d.T.array)]),
        withAllocatedMixin(allocated): { spec+: { ipam+: { pools+: { allocated+: if std.isArray(v=allocated) then allocated else [allocated] } } } },
        '#withRequested':: d.fn(help='"Requested contains a list of IPAM pool requests, i.e. indicates how many addresses this node requests out of each pool listed here. This field is owned and written to by cilium-agent and read by the operator."', args=[d.arg(name='requested', type=d.T.array)]),
        withRequested(requested): { spec+: { ipam+: { pools+: { requested: if std.isArray(v=requested) then requested else [requested] } } } },
        '#withRequestedMixin':: d.fn(help='"Requested contains a list of IPAM pool requests, i.e. indicates how many addresses this node requests out of each pool listed here. This field is owned and written to by cilium-agent and read by the operator."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requested', type=d.T.array)]),
        withRequestedMixin(requested): { spec+: { ipam+: { pools+: { requested+: if std.isArray(v=requested) then requested else [requested] } } } },
      },
      '#withIpv6-Pool':: d.fn(help='"IPv6Pool is the list of IPv6 addresses available to the node for allocation. When an IPv6 address is used, it will remain on this list but will be added to Status.IPAM.IPv6Used"', args=[d.arg(name='ipv6_pool', type=d.T.object)]),
      'withIpv6-Pool'(ipv6_pool): { spec+: { ipam+: { 'ipv6-pool': ipv6_pool } } },
      '#withIpv6-PoolMixin':: d.fn(help='"IPv6Pool is the list of IPv6 addresses available to the node for allocation. When an IPv6 address is used, it will remain on this list but will be added to Status.IPAM.IPv6Used"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipv6_pool', type=d.T.object)]),
      ...
      '#withPool':: d.fn(help='"Pool is the list of IPv4 addresses available to the node for allocation. When an IPv4 address is used, it will remain on this list but will be added to Status.IPAM.Used"', args=[d.arg(name='pool', type=d.T.object)]),
      withPool(pool): { spec+: { ipam+: { pool: pool } } },
      '#withPoolMixin':: d.fn(help='"Pool is the list of IPv4 addresses available to the node for allocation. When an IPv4 address is used, it will remain on this list but will be added to Status.IPAM.Used"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pool', type=d.T.object)]),
