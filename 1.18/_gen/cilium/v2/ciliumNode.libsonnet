{
  ...
  spec: {
    ...
    'alibaba-cloud': {
      '#withAvailability-Zone':: d.fn(help='"AvailabilityZone is the availability zone to use when allocating\\nENIs."', args=[d.arg(name='availability_zone', type=d.T.string)]),
      ...
      '#withSecurity-Group-Tags':: d.fn(help='"SecurityGroupTags is the list of tags to use when evaluating which\\nsecurity groups to use for the ENI."', args=[d.arg(name='security_group_tags', type=d.T.object)]),
      'withSecurity-Group-Tags'(security_group_tags): { spec+: { 'alibaba-cloud'+: { 'security-group-tags': security_group_tags } } },
      '#withSecurity-Group-TagsMixin':: d.fn(help='"SecurityGroupTags is the list of tags to use when evaluating which\\nsecurity groups to use for the ENI."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='security_group_tags', type=d.T.object)]),
      'withSecurity-Group-TagsMixin'(security_group_tags): { spec+: { 'alibaba-cloud'+: { 'security-group-tags'+: security_group_tags } } },
      '#withSecurity-Groups':: d.fn(help='"SecurityGroups is the list of security groups to attach to any ENI\\nthat is created and attached to the instance."', args=[d.arg(name='security_groups', type=d.T.array)]),
      ...
      '#withVswitch-Tags':: d.fn(help='"VSwitchTags is the list of tags to use when evaluating which\\nvSwitch to use for the ENI."', args=[d.arg(name='vswitch_tags', type=d.T.object)]),
      'withVswitch-Tags'(vswitch_tags): { spec+: { 'alibaba-cloud'+: { 'vswitch-tags': vswitch_tags } } },
      '#withVswitch-TagsMixin':: d.fn(help='"VSwitchTags is the list of tags to use when evaluating which\\nvSwitch to use for the ENI."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vswitch_tags', type=d.T.object)]),
    ...
    azure: {
      '#withInterface-Name':: d.fn(help='"InterfaceName is the name of the interface the cilium-operator\\nwill use to allocate all the IPs on"', args=[d.arg(name='interface_name', type=d.T.string)]),
    ...
    encryption: {
      '#withKey':: d.fn(help='"Key is the index to the key to use for encryption or 0 if encryption is\\ndisabled."', args=[d.arg(name='key', type=d.T.integer)]),
    ...
    eni: {
      ...
      '#withNode-Subnet-Id':: d.fn(help='"NodeSubnetID is the subnet of the primary ENI the instance was brought up\\nwith. It is used as a sensible default subnet to create ENIs in."', args=[d.arg(name='node_subnet_id', type=d.T.string)]),
      'withNode-Subnet-Id'(node_subnet_id): { spec+: { eni+: { 'node-subnet-id': node_subnet_id } } },
      '#withPre-Allocate':: d.fn(help='"PreAllocate defines the number of IP addresses that must be\\navailable for allocation in the IPAMspec. It defines the buffer of\\naddresses available immediately without requiring cilium-operator to\\nget involved.\\n\\nOBSOLETE: This field is obsolete, please use Spec.IPAM.PreAllocate"', args=[d.arg(name='pre_allocate', type=d.T.integer)]),
      'withPre-Allocate'(pre_allocate): { spec+: { eni+: { 'pre-allocate': pre_allocate } } },
      '#withSecurity-Group-Tags':: d.fn(help='"SecurityGroupTags is the list of tags to use when evaliating what\\nAWS security groups to use for the ENI."', args=[d.arg(name='security_group_tags', type=d.T.object)]),
      'withSecurity-Group-Tags'(security_group_tags): { spec+: { eni+: { 'security-group-tags': security_group_tags } } },
      '#withSecurity-Group-TagsMixin':: d.fn(help='"SecurityGroupTags is the list of tags to use when evaliating what\\nAWS security groups to use for the ENI."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='security_group_tags', type=d.T.object)]),
      ...
      '#withSubnet-Ids':: d.fn(help='"SubnetIDs is the list of subnet ids to use when evaluating what AWS\\nsubnets to use for ENI and IP allocation."', args=[d.arg(name='subnet_ids', type=d.T.array)]),
      'withSubnet-Ids'(subnet_ids): { spec+: { eni+: { 'subnet-ids': if std.isArray(v=subnet_ids) then subnet_ids else [subnet_ids] } } },
      '#withSubnet-IdsMixin':: d.fn(help='"SubnetIDs is the list of subnet ids to use when evaluating what AWS\\nsubnets to use for ENI and IP allocation."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnet_ids', type=d.T.array)]),
      'withSubnet-IdsMixin'(subnet_ids): { spec+: { eni+: { 'subnet-ids'+: if std.isArray(v=subnet_ids) then subnet_ids else [subnet_ids] } } },
      '#withSubnet-Tags':: d.fn(help='"SubnetTags is the list of tags to use when evaluating what AWS\\nsubnets to use for ENI and IP allocation."', args=[d.arg(name='subnet_tags', type=d.T.object)]),
      'withSubnet-Tags'(subnet_tags): { spec+: { eni+: { 'subnet-tags': subnet_tags } } },
      '#withSubnet-TagsMixin':: d.fn(help='"SubnetTags is the list of tags to use when evaluating what AWS\\nsubnets to use for ENI and IP allocation."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnet_tags', type=d.T.object)]),
      'withSubnet-TagsMixin'(subnet_tags): { spec+: { eni+: { 'subnet-tags'+: subnet_tags } } },
      '#withUse-Primary-Address':: d.fn(help="\"UsePrimaryAddress determines whether an ENI's primary address\\nshould be available for allocations on the node\"", args=[d.arg(name='use_primary_address', type=d.T.boolean)]),
    ...
    '#health':: d.obj(help='"HealthAddressing is the addressing information for health connectivity\\nchecking."'),
    health: {
    ...
    '#ipam':: d.obj(help='"IPAM is the address management specification. This section can be\\npopulated by a user or it can be automatically populated by an IPAM\\noperator."'),
    ipam: {
      '#pools':: d.obj(help='"Pools contains the list of assigned IPAM pools for this node."'),
      pools: {
        '#allocated':: d.obj(help='"Allocated contains the list of pooled CIDR assigned to this node. The\\noperator will add new pod CIDRs to this field, whereas the agent will\\nremove CIDRs it has released."'),
        allocated: {
          '#withCidrs':: d.fn(help='"CIDRs contains a list of pod CIDRs currently allocated from this pool"', args=[d.arg(name='cidrs', type=d.T.array)]),
          withCidrs(cidrs): { cidrs: if std.isArray(v=cidrs) then cidrs else [cidrs] },
          '#withCidrsMixin':: d.fn(help='"CIDRs contains a list of pod CIDRs currently allocated from this pool"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cidrs', type=d.T.array)]),
          withCidrsMixin(cidrs): { cidrs+: if std.isArray(v=cidrs) then cidrs else [cidrs] },
          '#withPool':: d.fn(help='"Pool is the name of the IPAM pool backing this allocation"', args=[d.arg(name='pool', type=d.T.string)]),
          withPool(pool): { pool: pool },
        },
        '#requested':: d.obj(help='"Requested contains a list of IPAM pool requests, i.e. indicates how many\\naddresses this node requests out of each pool listed here. This field\\nis owned and written to by cilium-agent and read by the operator."'),
        requested: {
          '#needed':: d.obj(help='"Needed indicates how many IPs out of the above Pool this node requests\\nfrom the operator. The operator runs a reconciliation loop to ensure each\\nnode always has enough PodCIDRs allocated in each pool to fulfill the\\nrequested number of IPs here."'),
          needed: {
            '#withIpv4-Addrs':: d.fn(help='"IPv4Addrs contains the number of requested IPv4 addresses out of a given\\npool"', args=[d.arg(name='ipv4_addrs', type=d.T.integer)]),
            'withIpv4-Addrs'(ipv4_addrs): { needed+: { 'ipv4-addrs': ipv4_addrs } },
            '#withIpv6-Addrs':: d.fn(help='"IPv6Addrs contains the number of requested IPv6 addresses out of a given\\npool"', args=[d.arg(name='ipv6_addrs', type=d.T.integer)]),
            'withIpv6-Addrs'(ipv6_addrs): { needed+: { 'ipv6-addrs': ipv6_addrs } },
          },
          '#withPool':: d.fn(help='"Pool is the name of the IPAM pool backing this request"', args=[d.arg(name='pool', type=d.T.string)]),
          withPool(pool): { pool: pool },
        },
        '#withAllocated':: d.fn(help='"Allocated contains the list of pooled CIDR assigned to this node. The\\noperator will add new pod CIDRs to this field, whereas the agent will\\nremove CIDRs it has released."', args=[d.arg(name='allocated', type=d.T.array)]),
        withAllocated(allocated): { spec+: { ipam+: { pools+: { allocated: if std.isArray(v=allocated) then allocated else [allocated] } } } },
        '#withAllocatedMixin':: d.fn(help='"Allocated contains the list of pooled CIDR assigned to this node. The\\noperator will add new pod CIDRs to this field, whereas the agent will\\nremove CIDRs it has released."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allocated', type=d.T.array)]),
        withAllocatedMixin(allocated): { spec+: { ipam+: { pools+: { allocated+: if std.isArray(v=allocated) then allocated else [allocated] } } } },
        '#withRequested':: d.fn(help='"Requested contains a list of IPAM pool requests, i.e. indicates how many\\naddresses this node requests out of each pool listed here. This field\\nis owned and written to by cilium-agent and read by the operator."', args=[d.arg(name='requested', type=d.T.array)]),
        withRequested(requested): { spec+: { ipam+: { pools+: { requested: if std.isArray(v=requested) then requested else [requested] } } } },
        '#withRequestedMixin':: d.fn(help='"Requested contains a list of IPAM pool requests, i.e. indicates how many\\naddresses this node requests out of each pool listed here. This field\\nis owned and written to by cilium-agent and read by the operator."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requested', type=d.T.array)]),
        withRequestedMixin(requested): { spec+: { ipam+: { pools+: { requested+: if std.isArray(v=requested) then requested else [requested] } } } },
      },
      '#withIpv6-Pool':: d.fn(help='"IPv6Pool is the list of IPv6 addresses available to the node for allocation.\\nWhen an IPv6 address is used, it will remain on this list but will be added to\\nStatus.IPAM.IPv6Used"', args=[d.arg(name='ipv6_pool', type=d.T.object)]),
      'withIpv6-Pool'(ipv6_pool): { spec+: { ipam+: { 'ipv6-pool': ipv6_pool } } },
      '#withIpv6-PoolMixin':: d.fn(help='"IPv6Pool is the list of IPv6 addresses available to the node for allocation.\\nWhen an IPv6 address is used, it will remain on this list but will be added to\\nStatus.IPAM.IPv6Used"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipv6_pool', type=d.T.object)]),
      'withIpv6-PoolMixin'(ipv6_pool): { spec+: { ipam+: { 'ipv6-pool'+: ipv6_pool } } },
      '#withMax-Above-Watermark':: d.fn(help='"MaxAboveWatermark is the maximum number of addresses to allocate\\nbeyond the addresses needed to reach the PreAllocate watermark.\\nGoing above the watermark can help reduce the number of API calls to\\nallocate IPs, e.g. when a new ENI is allocated, as many secondary\\nIPs as possible are allocated. Limiting the amount can help reduce\\nwaste of IPs."', args=[d.arg(name='max_above_watermark', type=d.T.integer)]),
      'withMax-Above-Watermark'(max_above_watermark): { spec+: { ipam+: { 'max-above-watermark': max_above_watermark } } },
      '#withMax-Allocate':: d.fn(help='"MaxAllocate is the maximum number of IPs that can be allocated to the\\nnode. When the current amount of allocated IPs will approach this value,\\nthe considered value for PreAllocate will decrease down to 0 in order to\\nnot attempt to allocate more addresses than defined."', args=[d.arg(name='max_allocate', type=d.T.integer)]),
      'withMax-Allocate'(max_allocate): { spec+: { ipam+: { 'max-allocate': max_allocate } } },
      '#withMin-Allocate':: d.fn(help='"MinAllocate is the minimum number of IPs that must be allocated when\\nthe node is first bootstrapped. It defines the minimum base socket\\nof addresses that must be available. After reaching this watermark,\\nthe PreAllocate and MaxAboveWatermark logic takes over to continue\\nallocating IPs."', args=[d.arg(name='min_allocate', type=d.T.integer)]),
      'withMin-Allocate'(min_allocate): { spec+: { ipam+: { 'min-allocate': min_allocate } } },
      '#withPodCIDRs':: d.fn(help='"PodCIDRs is the list of CIDRs available to the node for allocation.\\nWhen an IP is used, the IP will be added to Status.IPAM.Used"', args=[d.arg(name='podCIDRs', type=d.T.array)]),
      withPodCIDRs(podCIDRs): { spec+: { ipam+: { podCIDRs: if std.isArray(v=podCIDRs) then podCIDRs else [podCIDRs] } } },
      '#withPodCIDRsMixin':: d.fn(help='"PodCIDRs is the list of CIDRs available to the node for allocation.\\nWhen an IP is used, the IP will be added to Status.IPAM.Used"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podCIDRs', type=d.T.array)]),
      withPodCIDRsMixin(podCIDRs): { spec+: { ipam+: { podCIDRs+: if std.isArray(v=podCIDRs) then podCIDRs else [podCIDRs] } } },
      '#withPool':: d.fn(help='"Pool is the list of IPv4 addresses available to the node for allocation.\\nWhen an IPv4 address is used, it will remain on this list but will be added to\\nStatus.IPAM.Used"', args=[d.arg(name='pool', type=d.T.object)]),
      withPool(pool): { spec+: { ipam+: { pool: pool } } },
      '#withPoolMixin':: d.fn(help='"Pool is the list of IPv4 addresses available to the node for allocation.\\nWhen an IPv4 address is used, it will remain on this list but will be added to\\nStatus.IPAM.Used"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pool', type=d.T.object)]),
      withPoolMixin(pool): { spec+: { ipam+: { pool+: pool } } },
      '#withPre-Allocate':: d.fn(help='"PreAllocate defines the number of IP addresses that must be\\navailable for allocation in the IPAMspec. It defines the buffer of\\naddresses available immediately without requiring cilium-operator to\\nget involved."', args=[d.arg(name='pre_allocate', type=d.T.integer)]),
      'withPre-Allocate'(pre_allocate): { spec+: { ipam+: { 'pre-allocate': pre_allocate } } },
      '#withStatic-Ip-Tags':: d.fn(help='"StaticIPTags are used to determine the pool of IPs from which to\\nattribute a static IP to the node. For example in AWS this is used to\\nfilter Elastic IP Addresses."', args=[d.arg(name='static_ip_tags', type=d.T.object)]),
      'withStatic-Ip-Tags'(static_ip_tags): { spec+: { ipam+: { 'static-ip-tags': static_ip_tags } } },
      '#withStatic-Ip-TagsMixin':: d.fn(help='"StaticIPTags are used to determine the pool of IPs from which to\\nattribute a static IP to the node. For example in AWS this is used to\\nfilter Elastic IP Addresses."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='static_ip_tags', type=d.T.object)]),
      'withStatic-Ip-TagsMixin'(static_ip_tags): { spec+: { ipam+: { 'static-ip-tags'+: static_ip_tags } } },
    },
    ...
    '#withBootid':: d.fn(help='"BootID is a unique node identifier generated on boot"', args=[d.arg(name='bootid', type=d.T.string)]),
    withBootid(bootid): { spec+: { bootid: bootid } },
    '#withInstance-Id':: d.fn(help='"InstanceID is the identifier of the node. This is different from the\\nnode name which is typically the FQDN of the node. The InstanceID\\ntypically refers to the identifier used by the cloud provider or\\nsome other means of identification."', args=[d.arg(name='instance_id', type=d.T.string)]),
